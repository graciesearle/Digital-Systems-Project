...
def create_random_pose_gene():
    # Order: [Torso, Head, L_Shoulder, L_Elbow, R_Shoulder, R_Elbow, L_Hip, L_Knee, R_Hip, R_Knee]
    return [random.uniform(0, 2 * math.pi) for _ in range(10)]
...
def calculate_pose_coords(pose_gene):
    ...
    r_hip_ang, r_knee_ang] = pose_gene
    
    pose_coords = {}

    # --- Torso ---
    pose_coords["Hips"] = (0.5, 0.35)
    pose_coords["Neck"] = (
